...
class Others1(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            'image_path1': 'voting/B{}.jpg'.format(p1.participant.vars['subject_id']),
            'image_path2': 'voting/B{}.jpg'.format(p2.participant.vars['subject_id']),
            'image_path3': 'voting/B{}.jpg'.format(p3.participant.vars['subject_id']),
            'image_path4': 'voting/B{}.jpg'.format(p4.participant.vars['subject_id'])
        }
