...
class Others1(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            'image_path1': 'voting/R{}.jpg'.format(p1.participant.vars['subject_id']),
            'image_path2': 'voting/R{}.jpg'.format(p2.participant.vars['subject_id']),
            'image_path3': 'voting/R{}.jpg'.format(p3.participant.vars['subject_id']),
            'image_path4': 'voting/R{}.jpg'.format(p4.participant.vars['subject_id'])
        }
