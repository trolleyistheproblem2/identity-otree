...
class Rank(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            'image_path1': 'voting/R{}.jpg'.format(p1.subject_id),
            'image_path2': 'voting/R{}.jpg'.format(p2.subject_id),
            'image_path3': 'voting/R{}.jpg'.format(p3.subject_id),
            'image_path4': 'voting/R{}.jpg'.format(p4.subject_id),
